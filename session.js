const sessionUIControl = (function () {
   return {
      displayDashboard: function (user) {
         ...
         let mealButton = `                  <button class="accent"><a href="meals.php">See More Meals</a></button>`;
         let workoutButton = `<button class="accent"><a href="workouts.php">See More Workouts</a></button>`;

         if (user.caloriesGained == 0) {
            mealButton = `You don't have any meals yet. <br><br><button class="accent"><a href="meals.php">Add Meal</a></button>`;
         }

         if (user.caloriesLost == 0) {
            workoutButton = `You don't have any workouts yet. <br><br><button class="accent"><a href="workouts.php">Add Workout</a></button>`;
         }
         ...
         if (user.workouts == '' && user.meals == '') {
            ...
            <button class="accent"><a href="meals.php">Add Meal</a></button>
            <button class="accent"><a href="workouts.php">Add Workout</a></button>
         </div>
         <div class="row">
         ...
         <div class="row">
            <div class="col">
               <div class="dashboard-item center-text full-height">
                  ...
                  <button class="accent m-0"><a href="meals.php">Add Meal</a></button>
               </div>
            </div>
            <div class="col">
               <div class="dashboard-item center-text full-height">
                  ...
                  <button class="accent m-0"><a href="workouts.php">Add Workout</a></button>
               </div>
            </div>
         </div>
            `
